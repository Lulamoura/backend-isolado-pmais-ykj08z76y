...
assert.match(page, /Aprovar alteração de fórmula/, 'revisão IPCP deve permitir aprovação explícita da alteração de fórmula')
assert.match(page, /Alteração de fórmula aprovada/, 'revisão IPCP aprovada deve continuar visível como alteração aprovada')
...
assert.match(page, /a fórmula ainda não é recalculada automaticamente nesta etapa/, 'UI deve deixar claro que aprovar registra autorização, mas não recalcula a fórmula automaticamente')
