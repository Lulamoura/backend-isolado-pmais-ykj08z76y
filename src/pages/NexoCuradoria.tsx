                  ...
                  <div key={decisao.id} className="rounded-xl border border-amber-200 bg-white p-4">
                    ...
                    <div className="mt-3 space-y-2 text-sm text-slate-700">
                      ...
                      <p className="text-xs text-slate-600">
                        Ajuste as condições se a regra precisar de refinamento. Ao clicar em Aprovar
                        alteração de fórmula, a mudança fica autorizada e registrada, mas a fórmula
                        ainda não é recalculada automaticamente nesta etapa.
                      </p>
                    </div>
                    <div className="mt-4 flex flex-wrap gap-2">
                      <Button
