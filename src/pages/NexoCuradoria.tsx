          ...
          <div className="max-w-3xl space-y-3">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm font-medium text-slate-700">
                Este canal não grava direto no segundo cérebro. Ele organiza evidências,
                respostas curtas e propostas para revisão governada.
              </p>
            </div>
          </div>
          <Button
        ...
        <Card className="rounded-xl border-violet-200 bg-white shadow-sm">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex flex-wrap gap-2">
              <Button className="bg-violet-600 text-white hover:bg-violet-700">Começar entrevista</Button>
