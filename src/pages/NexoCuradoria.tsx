          ...
          <CardContent className="space-y-4">
            {etapaEntrevista === 0 ? (
              ...
              <>
                ...
                <div className="flex flex-wrap gap-2">
                  <Button onClick={avancarEntrevista} className="bg-violet-600 text-white hover:bg-violet-700">
                    {etapaEntrevista === perguntasEntrevista.length ? 'Enviar para revisão' : 'Próxima pergunta'}
                  </Button>
                  <Button variant="outline" onClick={fecharEntrevista}>
                    Fechar
                  </Button>
