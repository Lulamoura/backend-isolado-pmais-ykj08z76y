  ...
  function (e) {
    ...
    function snapshotAnteriorComparavel(snapshotAtual, rows) {
      ...
      for (var ai = 0; ai < rows.length; ai++) {
        ...
        if (rows[ai].id !== snapshotAtual.id && rowData < dataAtualSnapshot)
          return leituraPayload(rows[ai])
      }
      return null
    }
    ...
    return e.json(200, {
      ...
      evidencias: {
        ...
        fonte: evidenciasResposta ? evidenciasResposta.fonte : 'leitura_viva_ipcp_dados_reais',
