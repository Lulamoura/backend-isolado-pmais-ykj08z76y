...
routerAdd('GET', '/backend/v1/configuracoes/proposta-banner', function (e) {
  ...
  return e.json(200, resposta(registro()))
})
...
routerAdd(
  ...
  function (e) {
    ...
    if (perfil(ator) !== 'superadministrador') return e.json(403, { error: 'ACAO_NAO_AUTORIZADA' })
    return e.json(200, resposta(registro()))
  },
  $apis.requireAuth(),
)
...
routerAdd(
  ...
  function (e) {
    ...
    function auditar(ator, recordId, justificativa, evidencia) {
      try {
...
routerAdd(
  ...
  function (e) {
    ...
    function auditar(ator, recordId, justificativa) {
      try {
        var evidencia = { chave: 'proposta.banner_publico', restaurado_padrao: true },
          auditoria = new Record($app.findCollectionByNameOrId('com_auditoria'))
        auditoria.set('collection_name', 'com_configuracoes_arquivos')
        auditoria.set('record_id', recordId || 'proposta.banner_publico')
