...
;(function () {
  ...
  routerAdd(
    ...
    (e) => {
      ...
      var perfil = oePerfil($app, ator)
      // A referência da OE é um dado operacional interno e não altera o ActiveCampaign.
      // Por isso, negócios reais ganhos podem receber OE mesmo durante a pré-operação.
