...
routerAdd('POST', '/backend/v1/nexo/consulta-app', (e) => {
  ...
  function blocoIpcpLista(blocos) {
    var b = blocos || {}
    return [
      { chave: 'resultado_comercial', titulo: 'Resultado comercial', valor: Number(b.resultado_comercial || 0) },
      { chave: 'valor_estrategico', titulo: 'Valor estratégico', valor: Number(b.valor_estrategico || 0) },
      { chave: 'disciplina_carteira', titulo: 'Disciplina da carteira', valor: Number(b.disciplina_carteira || 0) },
      { chave: 'qualidade_followup', titulo: 'Qualidade de follow-up', valor: Number(b.qualidade_followup || 0) },
      { chave: 'registros_aprendizado', titulo: 'Registros e aprendizados', valor: Number(b.registros_aprendizado || 0) },
    ]
  }
  ...
  function consultaIpcpGerencial(body) {
    ...
    return resposta('ipcp_gerencial', {
      ...
      resumo_ipcp: {
        texto: limparTexto(resumo.texto || 'Leitura IPCP gerencial disponível para consulta do Nexo.', 700),
