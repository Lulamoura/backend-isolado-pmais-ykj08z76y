  ...
  (e) => {
    ...
    function acaoItemCentral(frente, n) {
      ...
      if (frente === 'notas-incompletas')
        return (
          'Completar a nota deste negócio com contato cliente, decisor, prazo prometido, objeção ou pendência e próximo passo combinado; não direcionar esta ação ao responsável interno ' +
          (n.responsavel_nome || 'não informado') +
          '.'
        )
      if (frente === 'propostas-sem-retorno')
        return (
          'Fazer follow-up consultivo com ' +
          destino +
          ' sobre a proposta deste negócio, confirmando recebimento/abertura, dúvidas e prazo de decisão.'
        )
      if (frente === 'followups-atrasados')
        return (
          'Reagendar e executar contato com ' +
          destino +
          ', registrando objetivo do follow-up, data combinada e quem decidirá pelo cliente.'
        )
      if (frente === 'risco-esfriamento')
        return (
          'Reaquecer a conversa com ' +
          destino +
          ', retomando necessidade, proposta ou pendência específica antes de o negócio perder tração.'
        )
      ...
      return (
        'Priorizar contato com ' +
        destino +
        ' hoje, com objetivo específico e registro claro do retorno esperado.'
      )
    }
