migrate(
  (app) => {
    ...
    collection.fields.add(new TextField({ name: 'segundo_cerebro_status', required: false, max: 80 }))
    collection.fields.add(new TextField({ name: 'segundo_cerebro_audit_id', required: false, max: 120 }))
    ...
    collection.fields.add(new TextField({ name: 'ipcp_revisao_blocos', required: false, max: 1000 }))
    collection.fields.add(new TextField({ name: 'ipcp_revisao_motivo', required: false, max: 2000 }))
