migrate(
  (app) => {
    ...
    record.set('descricao', 'URL base para abrir negócios diretamente no ActiveCampaign a partir do App Comercial PMais.')
    record.set('tipo', 'url')
    ...
    record.set('justificativa', 'Parâmetro criado para botões Abrir no ActiveCampaign nos cards de negócio.')
    app.save(record)
  },
  (app) => {
    try {
